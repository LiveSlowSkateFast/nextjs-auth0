...
export default class CookieStore {
  ...
  public read(req: IncomingMessage) {
    let session;
    ...
    try {
      ...
      if (existingSessionValue) {
        ...
        session = Session.fromString(cleartext.toString(), this.config, this.getClient, iat);
      }
    } catch (err) {
  ...
  public save(req: IncomingMessage, res: ServerResponse, session: Session | undefined | null) {
    const {
